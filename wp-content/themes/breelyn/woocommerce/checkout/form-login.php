...
<div class="woocommerce-form-login-toggle ">
	<?php wc_print_notice( apply_filters( 'woocommerce_checkout_login_message', __( 'Already Have an account?', 'woocommerce' ) ) . ' <a href="#" class="showlogin">' . __( 'Login', 'woocommerce' ) . '</a>', 'notice' ); ?>
</div>
<?php
